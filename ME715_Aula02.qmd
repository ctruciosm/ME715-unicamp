...
[Dado que $\beta_1$ mede o efeto de $X_1$ sobre $Y$ mantendo todos os outros fatores fixos, então é facil tirar conclusões _ceteris paribus_, certo?]{style="color:blue;"}
...
[**Infelizmente não. Como podemos aprender algo sobre o efeito _ceteris paribus_ de $X_1$ sobre $Y$ mantendo os outros fatores fixos se estamos ignorando todos os outros fatores?**]{style="color:red;"}
...
**Estas hipóteses são conhecidas como as hipóteses do modelo linear clássico.**
...
- $(\bar{x}_1, \cdots, \bar{x}_k, \bar{y})$ sempre está sobre a reta MQO.
